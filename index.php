...
?>
	 ...
	 width="100%" viewBox="0 0 560 560" enable-background="new 0 0 560 560" xml:space="preserve" aria-label="MD FILES">
<path fill="#000000" opacity="1.000000" stroke="none" 
	d="
M300.089355,395.250244 
	C279.217529,404.196838 257.933014,409.306885 234.160675,409.342224 
	C272.061035,322.074097 309.503204,235.860870 347.149780,149.177063 
	C348.570221,150.212280 349.325531,150.468018 349.533295,150.956589 
	C358.520386,172.090561 368.595123,192.845871 376.194916,214.470551 
	C401.131134,285.424927 368.461975,362.431458 300.089355,395.250244 
z"/>
<path fill="#000000" opacity="1.000000" stroke="none" 
	d="
M247.059143,186.065033 
	C254.606354,203.525574 261.976379,220.648361 269.445435,237.727829 
	C270.582428,240.327774 270.883087,242.661346 269.703949,245.366333 
	C246.554230,298.473206 223.451370,351.600494 200.391220,404.746277 
	C199.179672,407.538513 197.953705,409.485291 194.340393,409.467621 
	C169.847549,409.347870 145.353760,409.426880 120.860275,409.420227 
	C120.048180,409.420013 119.236153,409.190765 116.900124,408.838409 
	C154.515457,322.195435 191.919464,236.039200 229.323471,149.882980 
	C229.917755,149.902725 230.512039,149.922485 231.106323,149.942230 
	C236.375626,161.865860 241.644943,173.789490 247.059143,186.065033 
z"/>
<path fill="#000000" opacity="1.000000" stroke="none" 
	d="
M441.594360,363.491150 
	C448.099731,378.620483 454.453705,393.400696 461.137024,408.947021 
	C421.367706,408.947021 382.590149,408.947021 343.812592,408.947021 
	C343.471008,408.621765 343.129425,408.296539 342.787872,407.971283 
	C378.904663,380.849274 402.507263,345.545227 413.144989,301.764557 
	C413.623810,301.685394 414.102631,301.606232 414.581421,301.527069 
	C423.535278,322.065399 432.489136,342.603699 441.594360,363.491150 
z"/>
</svg>
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://files.mdjhs.com/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">MD FILES</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        <?php if (!FM_READONLY): ?>
            ...
            <div class="col-3 d-none d-sm-block"><a href="https://files.mdjhs.com/" target="_blank" class="float-right text-muted">MD FILES <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://files.mdjhs.com/" target="_blank" class="float-right text-muted">MD FILES <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
?>
    ...
    <head>
        ...
        <meta name="author" content="MD FILES">
...
?>
    ...
    <head>
        ...
        <title><?php echo fm_enc(APP_TITLE) ?> | <?php echo (isset($_GET['view']) ? $_GET['view'] : ((isset($_GET['edit'])) ? $_GET['edit'] : "MDJHS")); ?></title>
        <?php print_external('pre-jsdelivr'); ?>
